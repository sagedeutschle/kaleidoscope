# Kaleidoscope Shared Package Migration
...
they should read shared IDs and policies from `KaleidoscopeShared`.

## Current shared layer

- `KaleidoscopeFeatureManifest`
...
```
cd /Users/gtrktscrb/Desktop/GtrktscrBAPPDEV/mobile-development/KaleidoscopeShared
swift test
```
...
```
cd /Users/gtrktscrb/Desktop/GtrktscrBAPPDEV/mobile-development/Kaleidoscope
xcodegen generate
