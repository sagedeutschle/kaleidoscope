...
final class CatanAdventurerIntegrationTests: XCTestCase {
    func testCreatorAndDockExposeRequiredAccessibleCopy() throws {
        ...
        XCTAssertFalse(creator.contains("PrismetDesign.title("))
        XCTAssertFalse(creator.contains("PrismetDesign.rounded("))
        XCTAssertTrue(creator.contains(".system(.title, design: .serif"))
        XCTAssertTrue(creator.contains(".system(.headline, design: .rounded"))
