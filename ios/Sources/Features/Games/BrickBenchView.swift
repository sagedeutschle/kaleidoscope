...
private struct PlasticButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        ...
        configuration.label
            .font(Kaleido.rounded(compact ? 13 : 14, .semibold))
...
struct BrickBenchView: View {
    ...
    private var woodWorkbenchBackground: some View {
        Image("brickbench_wood")
            .resizable()
            .scaledToFill()
            .overlay(Color.black.opacity(Kaleido.isDark ? 0.34 : 0.14))
            .clipped()
            .ignoresSafeArea()
    }
        ...
        VStack(spacing: 12) {
            HStack {
                ...
                Text("Layer \(brick.layer)")
                    .font(Kaleido.rounded(12, .medium))
                    .monospacedDigit()
                    .foregroundStyle(Kaleido.ink2)
            }
...
private struct ExportSheet: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .padding(16)
            .background(Kaleido.ground.ignoresSafeArea())
