...
- **Launch evidence:** simulator processes `16350` (iPhone) and `16373` (iPad); installed macOS preview `/Users/gtrktscrb/Applications/Prismet Practice Casino.app` process `26215`; freshest main `/Users/gtrktscrb/Applications/Prismet.app` also open as process `99221`
